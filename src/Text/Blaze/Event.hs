...
onMouseOverM = onEvent . OnMouseOver . const

onBlurM :: IO act -> Attribute act
onBlurM = onEvent . OnBlur

onKeyPressM :: [Charcode] -> IO act -> Attribute act
onKeyPressM targetCharcodes = onEvent . OnKeyPress targetCharcodes

onClick :: [MouseButton] -> (MousePosition -> act) -> Attribute act
onClick btns mkAct = onEvent $ OnClick btns $ return . mkAct

onClick' :: act -> Attribute act
onClick' = onClick [LeftButton] . const

onDoubleClick :: [MouseButton] -> (MousePosition -> act) -> Attribute act
onDoubleClick btns mkAct = onEvent $ OnDoubleClick btns $ return . mkAct
...
onTextInputChange mkAct = onEvent $ OnValueChange $ return . mkAct

onCheckedChange :: (Bool -> act) -> Attribute act
onCheckedChange mkAct = onEvent $ OnCheckedChange $ return . mkAct

onKeyDown :: [Keycode] -> act -> Attribute act
onKeyDown targetKeys = onEvent . OnKeyDown targetKeys . return

onKeyPress :: [Charcode] -> act -> Attribute act
onKeyPress targetCharcodes = onKeyPressM targetCharcodes . return
-}
