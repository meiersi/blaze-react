...
import qualified Data.Aeson.Types as Json (Object)

import Text.Blaze.Internal (Attribute, AttributeValue, attribute, boolAttribute, objectAttribute)
...
style :: Json.Object  -- ^ Attribute value.
      -> Attribute ev    -- ^ Resulting attribute.
