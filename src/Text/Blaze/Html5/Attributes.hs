...
import Text.Blaze.Internal (Attribute, AttributeValue, attribute, boolAttribute, mapAttribute)
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @fillOpacity@ attribute.
--
-- Example:
--
-- > div ! fillopacity "bar" $ "Hello."
--
-- Result:
--
-- > <div fillOpacity="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @fontFamily@ attribute.
--
-- Example:
--
-- > div ! fontfamily "bar" $ "Hello."
--
-- Result:
--
-- > <div fontFamily="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @fontSize@ attribute.
--
-- Example:
--
-- > div ! fontsize "bar" $ "Hello."
--
-- Result:
--
-- > <div fontSize="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! gradienttransform "bar" $ "Hello."
--
-- Result:
--
-- > <div gradientTransform="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! gradientunits "bar" $ "Hello."
--
-- Result:
--
-- > <div gradientUnits="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @markerEnd@ attribute.
--
-- Example:
--
-- > div ! markerend "bar" $ "Hello."
--
-- Result:
--
-- > <div markerEnd="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @markerMid@ attribute.
--
-- Example:
--
-- > div ! markermid "bar" $ "Hello."
--
-- Result:
--
-- > <div markerMid="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @markerStart@ attribute.
--
-- Example:
--
-- > div ! markerstart "bar" $ "Hello."
--
-- Result:
--
-- > <div markerStart="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! offset "bar" $ "Hello."
--
-- Result:
--
-- > <div offset="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! opacity "bar" $ "Hello."
--
-- Result:
--
-- > <div opacity="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! patterncontentunits "bar" $ "Hello."
--
-- Result:
--
-- > <div patternContentUnits="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! patternunits "bar" $ "Hello."
--
-- Result:
--
-- > <div patternUnits="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! points "bar" $ "Hello."
--
-- Result:
--
-- > <div points="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! preserveaspectratio "bar" $ "Hello."
--
-- Result:
--
-- > <div preserveAspectRatio="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! spreadmethod "bar" $ "Hello."
--
-- Result:
--
-- > <div spreadMethod="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @stopColor@ attribute.
--
-- Example:
--
-- > div ! stopcolor "bar" $ "Hello."
--
-- Result:
--
-- > <div stopColor="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @stopOpacity@ attribute.
--
-- Example:
--
-- > div ! stopopacity "bar" $ "Hello."
--
-- Result:
--
-- > <div stopOpacity="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! stroke "bar" $ "Hello."
--
-- Result:
--
-- > <div stroke="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @strokeDasharray@ attribute.
--
-- Example:
--
-- > div ! strokedasharray "bar" $ "Hello."
--
-- Result:
--
-- > <div strokeDasharray="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @strokeLinecap@ attribute.
--
-- Example:
--
-- > div ! strokelinecap "bar" $ "Hello."
--
-- Result:
--
-- > <div strokeLinecap="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @strokeOpacity@ attribute.
--
-- Example:
--
-- > div ! strokeopacity "bar" $ "Hello."
--
-- Result:
--
-- > <div strokeOpacity="bar">Hello.</div>
--
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @strokeWidth@ attribute.
--
-- Example:
--
-- > div ! strokewidth "bar" $ "Hello."
--
-- Result:
--
-- > <div strokeWidth="bar">Hello.</div>
--
...
--
style :: Map String AttributeValue  -- ^ Attribute value.
      -> Attribute ev                 -- ^ Resulting attribute.
style = mapAttribute "style"
{-# INLINE style #-}
...
-- src/Util/GenerateHtmlCombinators.hs:249
--
-- | Combinator for the @textAnchor@ attribute.
--
-- Example:
--
-- > div ! textanchor "bar" $ "Hello."
--
-- Result:
--
-- > <div textAnchor="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! transform "bar" $ "Hello."
--
-- Result:
--
-- > <div transform="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! version "bar" $ "Hello."
--
-- Result:
--
-- > <div version="bar">Hello.</div>
--
...
-- Example:
--
-- > div ! viewbox "bar" $ "Hello."
--
-- Result:
--
-- > <div viewBox="bar">Hello.</div>
--
