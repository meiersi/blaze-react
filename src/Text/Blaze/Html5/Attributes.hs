...
-- | Combinator for the @acceptCharset@ attribute.
--
-- Example:
--
-- > form ! acceptcharset "UTF-8" $ "Hello."
--
-- Result:
--
-- > <form acceptCharset="UTF-8">Hello.</form>
--
acceptcharset :: AttributeValue  -- ^ Attribute value.
              -> Attribute ev    -- ^ Resulting attribute.
acceptcharset = attribute "acceptCharset" " acceptCharset=\""
...
-- Example:
--
-- > div ! allowfullscreen True $ "Hello."
--
-- Result:
--
-- > <div allowFullScreen=true>Hello.</div>
--
allowfullscreen :: Bool            -- ^ Attribute value.
                -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! async True $ "Hello."
--
-- Result:
--
-- > <div async=true>Hello.</div>
--
async :: Bool            -- ^ Attribute value.
      -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! autofocus True $ "Hello."
--
-- Result:
--
-- > <div autoFocus=true>Hello.</div>
--
...
-- Example:
--
-- > div ! autoplay True $ "Hello."
--
-- Result:
--
-- > <div autoPlay=true>Hello.</div>
--
autoplay :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! checked True $ "Hello."
--
-- Result:
--
-- > <div checked=true>Hello.</div>
--
...
class_ :: AttributeValue  -- ^ Attribute value.
       -> Attribute ev    -- ^ Resulting attribute.
class_ = attribute "className" " className=\""
{-# INLINE class_ #-}
...
-- Example:
--
-- > div ! controls True $ "Hello."
--
-- Result:
--
-- > <div controls=true>Hello.</div>
--
controls :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! defer True $ "Hello."
--
-- Result:
--
-- > <div defer=true>Hello.</div>
--
defer :: Bool            -- ^ Attribute value.
      -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! disabled True $ "Hello."
--
-- Result:
--
-- > <div disabled=true>Hello.</div>
--
disabled :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! formnovalidate True $ "Hello."
--
-- Result:
--
-- > <div formNoValidate=true>Hello.</div>
--
formnovalidate :: Bool            -- ^ Attribute value.
               -> Attribute ev    -- ^ Resulting attribute.
...
-- | Combinator for the @headersformEncType@ attribute.
--
-- Example:
--
...
-- Example:
--
-- > div ! hidden True $ "Hello."
--
-- Result:
--
-- > <div hidden=true>Hello.</div>
--
hidden :: Bool            -- ^ Attribute value.
       -> Attribute ev    -- ^ Resulting attribute.
...
-- | Combinator for the @itemID@ attribute.
--
-- Example:
--
-- > div ! itemid "bar" $ "Hello."
--
-- Result:
--
-- > <div itemID="bar">Hello.</div>
--
itemid :: AttributeValue  -- ^ Attribute value.
       -> Attribute ev    -- ^ Resulting attribute.
itemid = attribute "itemID" " itemID=\""
{-# INLINE itemid #-}

-- | Combinator for the @itemRef@ attribute.
--
-- Example:
--
-- > div ! itemref "bar" $ "Hello."
--
-- Result:
--
-- > <div itemRef="bar">Hello.</div>
--
itemref :: AttributeValue  -- ^ Attribute value.
        -> Attribute ev    -- ^ Resulting attribute.
itemref = attribute "itemRef" " itemRef=\""
{-# INLINE itemref #-}
...
-- Result:
--
-- > <div loop=true>Hello.</div>
--
loop :: Bool            -- ^ Attribute value.
     -> Attribute ev    -- ^ Resulting attribute.
...
-- | Combinator for the @marginHeight@ attribute.
--
-- Example:
--
-- > div ! marginheight "bar" $ "Hello."
--
-- Result:
--
-- > <div marginHeight="bar">Hello.</div>
--
marginheight :: AttributeValue  -- ^ Attribute value.
             -> Attribute ev    -- ^ Resulting attribute.
marginheight = attribute "marginHeight" " marginHeight=\""
{-# INLINE marginheight #-}

-- | Combinator for the @marginWidth@ attribute.
--
-- Example:
--
-- > div ! marginwidth "bar" $ "Hello."
--
-- Result:
--
-- > <div marginWidth="bar">Hello.</div>
--
marginwidth :: AttributeValue  -- ^ Attribute value.
            -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! multiple True $ "Hello."
--
-- Result:
--
-- > <div multiple=true>Hello.</div>
--
multiple :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! muted True $ "Hello."
--
-- Result:
--
-- > <div muted=true>Hello.</div>
--
muted :: Bool            -- ^ Attribute value.
      -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! novalidate True $ "Hello."
--
-- Result:
--
-- > <div noValidate=true>Hello.</div>
--
novalidate :: Bool            -- ^ Attribute value.
           -> Attribute ev    -- ^ Resulting attribute.
...
-- Result:
--
-- > <div open=true>Hello.</div>
--
open :: Bool            -- ^ Attribute value.
     -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! readonly True $ "Hello."
--
-- Result:
--
-- > <div readOnly=true>Hello.</div>
--
readonly :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! required True $ "Hello."
--
-- Result:
--
-- > <div required=true>Hello.</div>
--
required :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! scoped True $ "Hello."
--
-- Result:
--
-- > <div scope=true>Hello.</div>
--
scoped :: Bool            -- ^ Attribute value.
       -> Attribute ev    -- ^ Resulting attribute.
scoped = boolAttribute "scoped"
{-# INLINE scoped #-}
...
-- Example:
--
-- > div ! seamless True $ "Hello."
--
-- Result:
--
-- > <div seamless=true>Hello.</div>
--
seamless :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- Example:
--
-- > div ! selected True $ "Hello."
--
-- Result:
--
-- > <div selected=true>Hello.</div>
--
selected :: Bool            -- ^ Attribute value.
         -> Attribute ev    -- ^ Resulting attribute.
...
-- | Combinator for the @unselectable@ attribute.
--
-- Example:
--
-- > div ! unselectable "bar" $ "Hello."
--
-- Result:
--
-- > <div unselectable="bar">Hello.</div>
--
unselectable :: AttributeValue  -- ^ Attribute value.
             -> Attribute ev    -- ^ Resulting attribute.
unselectable = attribute "unselectable" " unselectable=\""
{-# INLINE unselectable #-}
